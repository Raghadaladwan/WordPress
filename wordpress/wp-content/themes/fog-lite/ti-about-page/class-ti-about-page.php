<?php
/**
 * Themeflux - About page class
 *
 * @package Themeflux
 * @subpackage Admin
 * @since 1.0.0
 */
if ( ! class_exists( 'fog_lite_TI_About_Page' ) ) {
	/**
	 * Singleton class used for generating the about page of the theme.
	 */
	class fog_lite_TI_About_Page {
		/**
		 * Define the version of the class.
		 *
		 * @var string $version The fog_lite_TI_About_Page class version.
		 */
		...
		/**
		 * The single instance of fog_lite_TI_About_Page
		 *
		 * @var fog_lite_TI_About_Page $instance The  fog_lite_TI_About_Page instance.
		 */
		private static $instance;

		/**
		 * The Main fog_lite_TI_About_Page instance.
		 *
		 * We make sure that only one instance of fog_lite_TI_About_Page exists in the memory at one time.
		 *
		 * @param array $config The configuration array.
		 */
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof fog_lite_TI_About_Page ) ) {
				self::$instance = new fog_lite_TI_About_Page;
			...
			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {
				...
				wp_localize_script(
					'ti-about-page-js', 'tiAboutPageObject', array(
						...
						'activating_string'   => __( 'Activating', 'fog-lite' ),
					)
				);
